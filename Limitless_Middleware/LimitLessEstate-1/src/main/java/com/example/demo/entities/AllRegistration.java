...
public class AllRegistration 
{
	...
	public AllRegistration(String first_name, String last_name, String mobile_no,  String email_id,
			String password,int role_id, String house_no, String building_name, String area, String city, int pincode,
