...
export default function AllRegistration(){
    ...
    return(
        ...
        <form className="Auth-form">
          ...
          <select name='roletype'id='roletype'required className='form-select'
          ...
          <select name='sourcetype' id='sourcetype' required className='form-select'
                onChange={(e) => {dispatch({type: 'update',fld: 'source_id',val: e.target.value,});}}>
